...
if (Meteor.isServer) {
  describe('UserSrv', () => {
    ...
    describe('signup', () => {
      it('should call Accounts.createUserVerifyingEmail with correct parameters', async () => {
    ...
    describe('configureEmails', () => {
      it('should correctly configure Accounts.emailTemplates', () => {
        sinon.stub(Meteor, 'settings').value({
          systemMail: {
            siteName: 'Test Site',
